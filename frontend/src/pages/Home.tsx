  ...
  return (
    <div>
      ...
      <section className="relative flex h-screen items-center justify-center overflow-hidden">
        ...
        <p className="absolute top-[20%] left-1/2 z-10 -translate-x-1/2 animate-[fadeDown_1.5s_ease-out] text-lg font-light uppercase tracking-[0.5em] text-white/70 sm:text-2xl">
          Welcome to
        </p>
        <div className="relative z-10 mt-44 text-center text-white">
